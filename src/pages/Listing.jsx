...
export default function Listing() {
  ...
  <a
  href="https://youtu.be/jUwiJsCTOlI?si=_j3zxkHA3w_aJZqM"
  target="_blank"
  rel="noopener noreferrer"
  className="bg-yellow-500 w-full max-w-[200px] rounded-md p-1 text-white text-center font-semibold shadow-md"
>
  Watch!
</a>
